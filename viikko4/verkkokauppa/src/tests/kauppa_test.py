...
class TestKauppa(unittest.TestCase):
    ...
    def test_purchase_with_one_product_calls_bank_with_correct_details(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_purchase_with_two_different_products_calls_bank_with_correct_details(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_purchase_with_two_identical_products_calls_bank_with_correct_details(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_purchase_with_available_and_out_of_stock_products_calls_bank_with_correct_details(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_calling_aloita_asiointi_resets_previous_purchase_information(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_store_requests_new_reference_number_for_each_payment_transaction(self):
        ...
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("teppo", "98765")
